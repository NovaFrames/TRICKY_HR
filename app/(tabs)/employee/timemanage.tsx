...
export default function TimeManage() {
    ...
    const handleShare = async () => {
        ...
        try {
            ...
            const result = await ApiService.downloadTimeReport(dates.fromDateStr, dates.toDateStr);
    ...
    const handleView = async () => {
        ...
        try {
            ...
            Alert.alert('Error', error?.message || 'Failed to open report. Please try again.');
        } finally {
            setDownloading(false);
        }
    };
            ...
            >
                <SafeAreaView style={{ flex: 1, backgroundColor: 'black' }}>
                    <View style={styles.viewerHeader}>
                        ...
                        <Text style={{ color: 'white', fontWeight: 'bold', flex: 1, textAlign: 'center' }}>Report Preview</Text>
