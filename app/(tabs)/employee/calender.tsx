...
export default function CalendarScreen() {
  ...
  const [detailData, setDetailData] = useState<
    { title: string; data: CalendarLeaveDetail[] }[]
  >([]);
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        const grouped = response.data.reduce(
          (acc: any, item: CalendarLeaveDetail) => {
  ...
  const renderItem = ({
    ...
    return (
      ...
      >
        <View
          style={[
            styles.eventDateSection,
            { backgroundColor: theme.primary + "10" },
          ]}
        >
          <View style={styles.dateCircle}>
            <Text style={[styles.eventDateNum, { color: theme.primary }]}>
              {dateNum}
            </Text>
          </View>
          <View style={styles.dateMeta}>
            ...
            <Text style={[styles.eventMonth, { color: theme.placeholder }]}>
              {monthStr}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.eventContent}>
          <View style={styles.eventTextContainer}>
            ...
            <View style={styles.eventMeta}>
              ...
              />
              <Text
                style={[styles.eventMetaText, { color: theme.placeholder }]}
              >
          ...
          <>
            ...
            {loading && (
              <View style={styles.center}>
                ...
                <Text
                  style={[styles.loadingText, { color: theme.placeholder }]}
                >
                  Loading events...
                </Text>
              </View>
