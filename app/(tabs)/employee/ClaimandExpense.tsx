...
const ClaimAndExpense: FC<ClaimAndExpenseProps> = () => {
    ...
    const travelTypes: string[] = ['Other Expenses', 'Flight', 'Train', 'Bus', 'Taxi', 'Travels', 'Two Wheeler', 'Accommodation/Food'];
    ...
    const fetchClaimList = async (): Promise<void> => {
        try {
            ...
            if (data.Status === 'success') {
                ...
                if (data.EnableCurrency && data.Currency && Array.isArray(data.Currency)) {
    ...
    const onFromDateChange = (event: DateTimePickerEvent, selectedDate?: Date): void => {
    ...
    const onToDateChange = (event: DateTimePickerEvent, selectedDate?: Date): void => {
    ...
    const handleAddTravel = (): void => {
        ...
        // Recalculate total
        const newTotal = travelExpenses.reduce((sum: number, item: TravelExpenseItem) => {
            if (editTravelIndex !== null && travelExpenses[editTravelIndex] === item) {
    ...
    const confirmSubmit = async (): Promise<void> => {
        ...
        try {
            ...
            const travelExpensesArray: TravelExpense[] = travelExpenses.map(expense => ({
