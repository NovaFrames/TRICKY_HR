    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        const uniqueDesignations = Array.from(
          new Set(sorted.map((emp) => emp.DescC)),
        );
        ...
        <View style={styles.employeeLeft}>
          ...
          <View style={styles.employeeInfo}>
            ...
            <View style={styles.employeeMeta}>
              <View
                style={[styles.codeBadge, { backgroundColor: theme.inputBg }]}
              >
                <Ionicons
                  name="card-outline"
                  size={12}
                ...
                />
                <Text
                  style={[styles.employeeCode, { color: theme.placeholder }]}
                >
                  {item.CodeC}
                </Text>
              </View>
            ...
            <View style={styles.designationRow}>
              ...
              />
              <Text
                style={[styles.designation, { color: theme.placeholder }]}
                numberOfLines={1}
              >
                {item.DescC}
              </Text>
    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      {loading ? (
        ...
        <View style={styles.emptyContainer}>
          <View
            style={[styles.emptyIconBox, { backgroundColor: theme.inputBg }]}
          >
            <Ionicons
