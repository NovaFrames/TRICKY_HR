...
const TimeModal: React.FC<TimeModalProps> = ({ visible, onClose, item, onRefresh }) => {
                ...
                { text: "No", style: "cancel" },
                {
                    ...
                    onPress: async () => {
                        ...
                        try {
                            ...
                            if (result.success) {
                                Alert.alert("Success", "Time update request cancelled successfully");
                                onClose();
                                onRefresh?.();
                            } else {
    ...
    const renderContent = () => {
        ...
        if (!timeData) {
            return (
                <View style={styles.emptyContainer}>
                    <Text style={[styles.emptyText, { color: theme.placeholder }]}>No time details available</Text>
                </View>
            );
        }
        ...
        return (
            <View style={styles.content}>
                <InfoRow label="Date" value={formatDate(timeData.DateD)} theme={theme} />
                <InfoRow label="Project Name" value={timeData.ProjectNameC || 'N/A'} theme={theme} />
                ...
                <InfoRow label="Remarks" value={timeData.TMSRemarksC || 'No remarks'} theme={theme} />
            </View>
        );
    };
