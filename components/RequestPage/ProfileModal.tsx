      ...
      <>
        ...
        <View style={styles.section}>
          ...
          <InfoRow
            ...
            value={getMaritalStatus(profile.MaritalN)}
            theme={theme}
          />
          {profile.MaritalN === 1 && (
            <InfoRow
              label="Marriage Date"
              value={formatDate(profile.MarriedDateD)}
              theme={theme}
            />
          )}
          <InfoRow
            label="Blood Group"
            value={getBloodGroup(profile.BloodTypeN)}
            theme={theme}
          />
          <InfoRow
            label="Phone No."
        ...
        <View style={styles.section}>
          ...
          <InfoRow
            label="Issue Date"
            value={formatDate(profile.IssueDateD)}
            theme={theme}
          />
          <InfoRow
            label="Expiry date"
            value={formatDate(profile.ExpiryDateD)}
            theme={theme}
          />
        </View>
          ...
          <View style={styles.section}>
            ...
            {children.map((child: any, index: number) => {
              ...
              return (
                <View
                  key={index}
                  style={[styles.childCard, { backgroundColor: theme.inputBg }]}
                >
                  <Text style={[styles.childName, { color: theme.text }]}>
                    {child.NameC || "N/A"}
                  </Text>
                  <Text
                    style={[styles.childDetail, { color: theme.placeholder }]}
                  >
          ...
          <View style={styles.section}>
            ...
            {education.map((edu: any, index: number) => {
              ...
              return (
                <View
                  key={index}
                  style={[styles.eduCard, { backgroundColor: theme.inputBg }]}
                >
                  <Text style={[styles.eduTitle, { color: theme.text }]}>
                    {edu.EducationC || "N/A"}
                  </Text>
                  <Text
                    style={[styles.eduDetail, { color: theme.placeholder }]}
                  >
