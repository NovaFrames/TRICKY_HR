...
const LeaveModal: React.FC<LeaveModalProps> = ({ visible, onClose, item, onRefresh }) => {
                    ...
                    onPress: async () => {
                        ...
                        try {
                            ...
                            if (result.success) {
                                ...
                                Alert.alert("Error", result.error || "Failed to cancel leave request.");
                            }
                        } catch (error: any) {
    ...
    const renderContent = () => {
        ...
        if (!leaveData) {
            return (
                <View style={styles.emptyContainer}>
                    <Text style={[styles.emptyText, { color: theme.placeholder }]}>No leave details available</Text>
                </View>
            );
        }
        ...
        const formatDate = (dateVal: any): string => {
            try {
                ...
                if (typeof dateVal === 'string' && dateVal.includes('/Date(')) {
                    ...
                    return date.toLocaleDateString('en-US', { day: 'numeric', month: 'short', year: 'numeric' }) || 'N/A';
                }
        ...
        const formatNumber = (numVal: any): string => {
            try {
                if (numVal === null || numVal === undefined || numVal === 0) return 'N/A';
        ...
        const displayValues = {
            ...
            remarks: safeString(leaveData.LVRemarksC) === 'N/A' ? 'No remarks' : safeString(leaveData.LVRemarksC),
            fromTime: formatNumber(leaveData.FHN),
            toTime: formatNumber(leaveData.THN),
            totalHours: formatNumber(leaveData.THrsN),
            claimAmount: leaveData.MLClaimAmtN && leaveData.MLClaimAmtN > 0
        ...
        return (
            <View style={styles.content}>
                <View style={styles.infoRow}>
                    <Text style={[styles.infoLabel, { color: theme.textLight }]}>From Date</Text>
                ...
                <View style={styles.infoRow}>
                    <Text style={[styles.infoLabel, { color: theme.textLight }]}>To Date</Text>
                    <Text style={[styles.infoValue, { color: theme.text }]} numberOfLines={2}>
                ...
                <View style={styles.infoRow}>
                    <Text style={[styles.infoLabel, { color: theme.textLight }]}>Leave Type</Text>
                    <Text style={[styles.infoValue, { color: theme.text }]} numberOfLines={2}>
                ...
                <View style={styles.infoRow}>
                    <Text style={[styles.infoLabel, { color: theme.textLight }]}>Remarks</Text>
                ...
                {hasPermission ? (
                    <View style={[styles.section, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder }]}>
                        <Text style={[styles.sectionTitle, { color: theme.primary }]}>Permission Details</Text>

                        <View style={styles.infoRow}>
                            <Text style={[styles.infoLabel, { color: theme.textLight }]}>From Time</Text>
                        ...
                        <View style={styles.infoRow}>
                            <Text style={[styles.infoLabel, { color: theme.textLight }]}>To Time</Text>
                            <Text style={[styles.infoValue, { color: theme.text }]}>
                        ...
                        <View style={styles.infoRow}>
                            <Text style={[styles.infoLabel, { color: theme.textLight }]}>Total Hours</Text>
                            <Text style={[styles.infoValue, { color: theme.text }]}>
                ...
                {hasMedicalClaim ? (
                    <View style={[styles.section, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder }]}>
                        <Text style={[styles.sectionTitle, { color: theme.primary }]}>Medical Claim</Text>

                        <View style={styles.infoRow}>
                            <Text style={[styles.infoLabel, { color: theme.textLight }]}>Claim Amount</Text>
                            <Text style={[styles.infoValue, { color: theme.text }]}>
