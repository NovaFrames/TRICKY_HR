...
const SurrenderLeaveModal: React.FC<SurrenderLeaveModalProps> = ({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (result.success) {
                Alert.alert('Success', 'Request submitted successfully!', [{ text: 'OK', onPress: onSuccess }]);
            } else {
            ...
            >
                <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
                    <View style={[styles.eligibilityCard, { backgroundColor: theme.inputBg }]}>
                        ...
                        {checkingEligibility ? (
                            ...
                            <View style={styles.eligibilityRow}>
                                <Text style={[styles.eligibilityLabel, { color: theme.secondary }]}>Available for Surrender:</Text>
                                <Text style={[styles.eligibilityValue, { color: theme.primary }]}>{eligibleDays} Days</Text>
                            </View>
                        )}
                    </View>
                    ...
                    <View style={styles.formGroup}>
                        ...
                        <TouchableOpacity style={dateInputStyle} onPress={() => setShowDatePicker(true)}>
                            <Text style={{ color: theme.text }}>{payoutDate.toLocaleDateString()}</Text>
